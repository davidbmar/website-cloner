...
class IndexPageGenerator {
  ...
  async analyzeS3Site(prefixName) {
    try {
      ...
      // Try to fetch creator information
      let creator = null;
      try {
        ...
        // Creator info not found or error reading it - that's okay
        this.logger.debug(`No creator info for ${prefixName}`);
      }
      ...
      return {
        ...
        creator: creator   // Add creator information
      };
    } catch (error) {
      ...
      <div class="site-card">
        ...
        <div class="site-details">
          ...
          <div class="detail-row creator-row">
            ...
            <span class="detail-value creator-name">${site.creator.username}</span>
          </div>
          ` : ''}
